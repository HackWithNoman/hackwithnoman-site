      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-4">
          <p className="text-[1.125rem] leading-[1.7] text-[#111827]">
            Hi, I'm{" "}
            <span className="text-[#D84B7E] font-semibold">Noman</span>! I'm a
        ...
        <div className="space-y-6">
          {/* Skills/Interests */}
          <div className="bg-[#FAF9F6] border border-[#E5E7EB] rounded-lg p-6">
            <h3 className="text-lg font-bold mb-4 text-[#111827]">What I Do</h3>
                ...
                return (
                  <li key={skill.label} className="flex items-center gap-3">
                    <Icon
                      size={16}
                      strokeWidth={1.5}
                      className="text-[#D84B7E]"
                    />
                    <span className="text-sm text-[#111827]">{skill.label}</span>
                  </li>
                );
              })}
            </ul>
